...
class OFAProxylessNASNets(ProxylessNASNets):
    ...
    def __init__(self, n_classes=1000, bn_param=(0.1, 1e-3), dropout_rate=0.1, base_stage_width=None,
        ...
        # print(len(input_channel))
        # print('input_channel', input_channel)
        # print(len(first_block_width))
        # print(first_block_width)
        # first conv layer
        ...
        # print('block type : ', type(self.blocks[2]))
        # set bn param
        self.set_bn_param(momentum=bn_param[0], eps=bn_param[1])
        #print("len blocks : {}".format(len(blocks)))        
        # runtime_depth
        self.runtime_depth = [
    ...
    def forward(self, x):
        ...
        # avg_pool = torch.nn.AvgPool2d((5, 5))
    ...
    def get_active_subnet(self, preserve_weight=True):
        ...
        # print('first conv type :', type(first_conv))
        blocks = [copy.deepcopy(self.blocks[0])]
        feature_mix_layer = copy.deepcopy(self.feature_mix_layer)
        # print(type(feature_mix_layer))
        ...
        for stage_id, block_idx in enumerate(self.block_group_info):
            ...
            for idx in active_idx:
                ...
                # print(idx)
                # print(stage_blocks[-1].shortcut, stage_blocks[-1].mobile_inverted_conv.use_se, stage_blocks[-1].mobile_inverted_conv.act_func)
            blocks += stage_blocks
            # print(type(stage_blocks))
            # print(len(stage_blocks))
            # print(stage_blocks)
        # print(len(blocks))
        # print(blocks)
